"""Thin wrapper around the Stripe SDK for subscription-mode operations.

Artwork-sale one-off payment operations live in `artworks/stripe_orders.py`.
Both modules import `core.stripe` for SDK initialization; this module keeps the
subscription surface (customers, subscription Checkout, billing portal,
prices, and subscription reads).
"""
