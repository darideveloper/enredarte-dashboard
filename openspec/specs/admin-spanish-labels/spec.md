...
Every concrete model field shown in the admin SHALL display a Spanish label, including fields inherited from the abstract base models (`created_at`, `updated_at`, `slug`, `is_active`, `sort_order`, `language`, `name`, `email`, `website`, `photo`) and concrete fields (`birth_year`, `death_year`, `location`, `bio`, `platform`, `url`, `logo`, `curator`, `description`, `year`, `dimensions`, `price_mxn`, `price_usd`, `status`, `is_highlighted`, `views_count`, `title`, `image`, `alt_es`, `alt_en`, `is_primary`).
