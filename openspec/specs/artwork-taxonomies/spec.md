# Artwork Taxonomies Specification

## Purpose
To define the requirements for the five translatable taxonomy models — Discipline, Technique, Theme, Format, and Scale — used to classify artworks across the client's filter dimensions, their ManyToMany links to Artwork, the removal of Surface, and the base/seed fixture data that seeds them.
